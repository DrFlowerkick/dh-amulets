    ...
    view! {
        ...
        <div class="text-base text-content mb-2 space-y-2">
            <p>
                ...
                ", einem Kartenspiel erschienen im "
        ...
        <div class="text-base text-content mb-2 space-y-2">
            <p>
                <strong>"Drachenhüter Amulett Setup"</strong>" ist als "
                <a href="https://de.wikipedia.org/wiki/Progressive_Webanwendung" class="link link-primary">
        ...
        <div class="text-base text-content mb-2 space-y-2">
            <p>
                "Um die App unter Android zu installieren, muss diese zum "<strong>"Startbildschirm"</strong>
                " hinzugefügt werden:"
            </p>
            <ul class="list-disc pl-5 text-base-content">
                <li>
                    <strong>"firefox"</strong>" Tippe auf die drei Punkte, danach \"App zum Startbildschirm hinzufügen\" auswählen."
                </li>
                <li>
                    <strong>"vivaldi"</strong>" Tippe auf das vivaldi icon, danach \"Seite hinzufügen zu ...\" auswählen 
                    und dann Startbildschirm wählen."
                </li>
            </ul>
            <p>"In anderen Browsern wird das Vorgehen wahrscheinlich ähnlich sein, wurde aber bisher nicht getestet."</p>
        </div>
        <h3 class="text-xl text-center md:text-left font-semibold tracking-wide text-secondary mb-4">
        ...
        <div class="text-base text-content mb-2 space-y-2">
            ...
            <ul class="list-disc pl-5 text-base-content">
                <li>
                    <strong>"chromium"</strong>" Links-click auf das "<em>"Monitor Symbol mit dem Pfeil nach unten"</em>" rechts in der
                ...
                <li>
                    <strong>"vivaldi"</strong>" Rechts-click in der Tableiste auf den Tab mit der geöffneten Drachenhüter 
